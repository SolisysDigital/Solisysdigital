...
export async function GET(req: Request) {
  ...
  let feed = new Feed({
    title: 'The Solisys Digital Blog',
    description:
      'Stay informed with Salesforce implementation insights, digital marketing strategies, and company news from Solisys Digital.',
    author: {
      name: 'Michael Foster',
